...
/**
 * Created by fhanik on 5/20/15.
 */
public class NoOpPasswordScoreCalculator implements PasswordScoreCalculator {
    private final PasswordScore score = new PasswordScore(100, 0);

    public NoOpPasswordScoreCalculator(int required) {}
